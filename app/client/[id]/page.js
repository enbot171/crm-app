...
import { CLIENT_STATUSES, CONTACT_TYPES, getStatusStyle, DEFAULT_FOLLOW_UP_DAYS } from "@/config/app";
        ...
        <div className="space-y-3">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-gray-600">How often this client should appear in your follow-up list, counted from the last time you marked them as contacted. Leave blank to use your account default ({profile?.followUpDays ?? DEFAULT_FOLLOW_UP_DAYS} days).</p>
              <input
                type="number"
                min={1}
                max={365}
  ...
  return (
    <div
      ...
      className={`flex justify-between items-center rounded-xl px-3.5 py-3 cursor-pointer transition-all border ${
        checked ? "bg-green-500 border-green-500 text-white" : "bg-gray-50 border-gray-200 text-gray-700"
      }`}
    >
